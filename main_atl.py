...
start = time.time()
url_atl = 'https://atlantmarket.com.ua/price1/prom/atlantmarketprom(false).xml'
urllib.request.urlretrieve(url_atl, 'price/atlantmarket.xml')
...
print(f'Файл "atlantmarket.xml" перезаписано. Час виконання {int(end)} секунд.')
